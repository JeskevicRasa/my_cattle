...
# If the group_name exists in the dictionary, it will return the corresponding list of cattle;
...
# Note: Make sure that the GroupNumbers class is defined and imported correctly to use it as the type hint for the
